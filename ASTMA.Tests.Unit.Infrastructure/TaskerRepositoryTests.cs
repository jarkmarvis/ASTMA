...
public class Tests
{
    ...
    private Mock<IApplicationDbContext<TaskerDocument>> _mockMongoDbContext;
    ...
    public void SetUp()
    {
        ...
        _mockMongoDbContext = new Mock<IApplicationDbContext<TaskerDocument>>();
    ...
    {
        // Arrange
        var expected = new TaskerDocument { Id = "taskerId", Title = "Sample Task Title" };
    ...
    public void GetById_WhenUserDoesNotExist_ReturnsNull()
    {
        ...
        // Act
        var result = _taskerRepository.GetAsync("invlaid-id");
